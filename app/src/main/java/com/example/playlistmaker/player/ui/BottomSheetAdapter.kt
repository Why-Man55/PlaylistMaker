...
class BottomSheetAdapter(private val playlistOnClicked: PlaylistOnClicked) :
    ListAdapter<Playlist, BottomSheetViewHolder>(PlaylistItemComparator()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BottomSheetViewHolder {
        val layoutInspector = LayoutInflater.from(parent.context)
        return BottomSheetViewHolder(
            SimplePlaylistViewBinding.inflate(
                layoutInspector,
                parent,
                false
            )
